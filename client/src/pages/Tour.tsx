...
const FALLBACK_TOUR_DATES: TourDate[] = [
  ...
  { id: 6, city: "Honolulu", state: "HI", date: "May 22-23", time: "9am-6pm", venue: "Shangri-la Museum of Islamic Art, Culture and Design", rsvpLink: "https://www.eventbrite.com/e/1984515233485?aff=oddtdtcreator", description: "Registration Now Open" },
  { id: 21, city: "Los Angeles", state: "CA", date: "May 28", time: "TBA", venue: "TBA", rsvpLink: "gathering", description: null },
  { id: 10, city: "Vancouver", state: "CAN", date: "June 4-7", time: null, venue: "Vancouver International Publishing Conference, The Wallace Venue", rsvpLink: "https://myhealinglanguage.us14.list-manage.com/subscribe?u=797dcb18d0b3bd1a465515271&id=0488831fc9", description: null },
